                    ...
                    {courses.map((course) => (
                        ...
                        >
                            ...
                            <div className="p-4">
                                ...
                                {/* Инфо */}
                                <div className="flex flex-wrap items-center justify-between text-xs sm:text-sm text-gray-500 mb-4 gap-y-2">
                  <span className="flex items-center gap-1">
                    <FaBookBookmark /> {course.lessons} Lesson
                  </span>
                                    <span className="flex items-center gap-1">
                    <FaUserGraduate /> {course.students} Student
                  </span>
                                    <span className="flex items-center gap-1">
