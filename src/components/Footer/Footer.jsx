    ...
    <footer className="bg-blue-900 text-gray-300">
      <div className="container mx-auto py-10 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
          ...
          {/* Column 2: Courses */}
          <div className="flex flex-col items-center md:items-start">
            <h3 className="text-white font-bold mb-3">Speak up courses</h3>
            <ul className="space-y-2">
              <li><a href="#" className="hover:text-white">Learn english</a></li>
              <li><a href="#" className="hover:text-white">Learn Turkish</a></li>
              <li><a href="#" className="hover:text-white">Learn French</a></li>
            </ul>
          </div>
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <ul className="space-y-2">
              <li><a href="#" className="hover:text-white">Landing page</a></li>
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center space-x-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z"></path><circle cx="12" cy="9" r="3"></circle></svg>
