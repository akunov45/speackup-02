...
const Footer = () => {
  // Анимация будет включена только на экранах с шириной 1024px и более (десктоп)
  ...
  return (
    <footer className="bg-gradient-to-r from-blue-600 to-blue-800 text-gray-300">
      {/* Условный рендеринг: motion.div для десктопов, обычный div для остальных */}
      {isDesktop ? (
        <motion.div {...containerProps} {...animatedProps}>
          {/* Содержимое футера */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 text-center md:text-left">
            ...
            <div className="flex flex-col items-center md:items-start">
              ...
              <ul className="space-y-3 text-base md:text-lg">
                <li><a className="hover:text-white transition-colors duration-200">Landing Page</a></li>
                <li><NavLink to={"/about"} className="hover:text-white transition-colors duration-200">About Us</NavLink></li>
